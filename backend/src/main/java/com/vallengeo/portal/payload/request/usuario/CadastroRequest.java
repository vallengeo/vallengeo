...
public record CadastroRequest(@NotEmpty(message = CAMPO_OBRIGATORIO) String email,
    ...
    public record Tela(@NotEmpty(message = CAMPO_OBRIGATORIO) String id,
     @NotNull(message = CAMPO_OBRIGATORIO) @Valid @Size(min = 1, message = CAMPO_OBRIGATORIO)
