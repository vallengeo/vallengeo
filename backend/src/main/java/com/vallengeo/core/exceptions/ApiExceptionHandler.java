...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleApiRequestException(BadCredentialsException ex) {
        ...
        return new ResponseEntity<>(new ApiExceptionCustom(HttpStatus.FORBIDDEN, "Usuário e/ou senha inválidos.", "Falha na autenticação!", ex), HttpStatus.FORBIDDEN);
    }
    ...
    public ResponseEntity<ApiExceptionCustom> handleBadRequestExecption(BadRequestException bre) {
